...
def about():
    messagebox.showinfo('About Graph-It Easy', 'Creator: Ross Waters\nEmail: RossWatersjr@gmail.com'\
        ...
        '\nRevision \ Date: 1.1.9 \ 02/20/2023'\
...
if __name__ == "__main__":
    ...
    configure_ab=Menu(menubar,background='aqua',foreground='black',tearoff=0)# File Menu and commands
    menubar.add_cascade(label='About',menu=configure_ab)
    configure_ab.add_command(label='About',command=lambda:about())
    configure_ab.add_separator()
    root.config(menu=menubar)
