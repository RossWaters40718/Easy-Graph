...
class Test():
    def log(exe_style):# Example
        ...
        set_y_scale('-10,10')
        #//////////////////////////////
        # Customize line2d Properties, X and/or Y Asis Tick Labels And Legends
        ...
        # Spares, Setup As Needed
        #Set Plot 3 2DLine  Properties
        plt3_color=Window_Color.get()# Set The line2d Color
        plt3_style='solid'# Set The line2d Style
        plt3_width=1# Set The line2d Width
        #Set Plot 3 2DLine  Properties
        plt4_color=Window_Color.get()# Set The line2d Color
        plt4_style='solid'# Set The line2d Style
        plt4_width=1# Set The line2d Width
        #Set Plot 3 2DLine  Properties
        plt5_color=Window_Color.get()# Set The line2d Color
        plt5_style='solid'# Set The line2d Style
        plt5_width=1# Set The line2d Width
        # Plot Legends
...
# ****************************** Plot 2 ******************************
    ...
    def linear(exe_style):# Example
        ...
        plt1_width=1# Set The line2d Width
        #Set Plot 2 2DLine  Properties
        plt2_color='red'# Set The line2d Color
